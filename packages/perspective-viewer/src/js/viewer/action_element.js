...
export class ActionElement extends DomElement {
    ...
    _sort_order_clicked(event) {
        ...
        const column_sorting = this._get_view_column_pivots().length > 0;
        const new_sort_order = this._increment_sort(row.getAttribute("sort-order"), column_sorting, abs_sorting);
