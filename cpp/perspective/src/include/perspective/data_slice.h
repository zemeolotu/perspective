...
public:
    t_data_slice(std::shared_ptr<CTX_T> ctx, t_index start_row, t_index end_row,
        t_index start_col, t_index end_col, std::shared_ptr<std::vector<t_tscalar>> slice,
        std::shared_ptr<std::vector<std::string>> column_names);

    t_data_slice(std::shared_ptr<CTX_T> ctx, t_index start_row, t_index end_row,
        t_index start_col, t_index end_col, std::shared_ptr<std::vector<t_tscalar>> slice,
        std::shared_ptr<std::vector<std::string>> column_names,
        std::shared_ptr<std::vector<t_index>> column_indices);
    ...
    std::shared_ptr<std::vector<t_index>> get_column_indices() const;
...
private:
    ...
    std::shared_ptr<std::vector<t_index>> m_column_indices;
};
